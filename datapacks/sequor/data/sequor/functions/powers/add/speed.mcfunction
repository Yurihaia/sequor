...
execute if score return calc matches 0 run data modify block 0 0 0 RecordItem.tag.powerStack append value 1b
execute if score return calc matches 0 run scoreboard players add powers store 1
